...
import com.mecavia.site.serviceimplies.BillOfMaterialService;
...
@CrossOrigin(origins = "*")
public class BillOfMaterialController implements com.mecavia.site.controller.BillOfMaterialController {
	@Autowired
