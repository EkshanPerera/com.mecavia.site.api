...
import com.mecavia.site.serviceimplies.PurchaseRequisitionService;
...
@CrossOrigin(origins = "*")
public class PurchaseRequisitionController implements com.mecavia.site.controller.PurchaseRequisitionController {
	@Autowired
