...
import com.mecavia.site.serviceimplies.GoodsReceivedNoteService;
...
@CrossOrigin(origins = "*")
public class GoodsReceivedNoteController implements com.mecavia.site.controller.GoodsReceivedNoteController {
	@Autowired
