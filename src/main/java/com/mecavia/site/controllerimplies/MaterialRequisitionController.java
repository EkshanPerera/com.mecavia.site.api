...
import com.mecavia.site.serviceimplies.MaterialRequisitionService;
...
@CrossOrigin(origins = "*")
public class MaterialRequisitionController implements com.mecavia.site.controller.MaterialRequisitionController {
	@Autowired
