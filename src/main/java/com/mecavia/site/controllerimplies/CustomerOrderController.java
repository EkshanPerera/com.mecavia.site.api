...
import com.mecavia.site.serviceimplies.CustomerOrderService;
...
@CrossOrigin(origins = "*")
public class CustomerOrderController implements com.mecavia.site.controller.CustomerOrderController {
	@Autowired
