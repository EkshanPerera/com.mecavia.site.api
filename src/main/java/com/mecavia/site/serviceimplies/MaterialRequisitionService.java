...
@Service
@Transactional
public class MaterialRequisitionService  implements com.mecavia.site.service.MaterialRequisitionService{
	@Autowired
	...
	public String saveMaterialRequisition(MaterialRequisitionDto materialRequisitiondto) {
		if(materialRequisitionrepo.existsById(materialRequisitiondto.getId())) {
			...
			for(MaterialRequisitionMaterialDto grnMaterialDto : materialRequisitiondto.getMaterialRequisitionMaterials()) {
			    MaterialRequisitionMaterial grnMaterial = modelMapper.map(grnMaterialDto, MaterialRequisitionMaterial.class);
			    grnMaterial.setMaterialRequisition(materialRequisition);
			    materialRequisitionMaterials.add(grnMaterial);
			}
